...
const modalBackdropStyle = tva({
  base: "absolute left-0 top-0 right-0 bottom-0 bg-background-950/50 dark:bg-background-0/50 web:cursor-default",
});

const modalContentStyle = tva({
  base: "bg-background-0 dark:bg-background-950 rounded-md overflow-hidden border border-outline-200 dark:border-outline-800 shadow-hard-2 p-6",
  parentVariants: {
    size: {
      xs: "w-[60%] max-w-[360px]",
      sm: "w-[70%] max-w-[420px]",
...
const modalCloseButtonStyle = tva({
  base: "group/modal-close-button z-10 rounded data-[focus-visible=true]:web:bg-background-100 dark:data-[focus-visible=true]:web:bg-background-900 web:outline-0 cursor-pointer",
});
