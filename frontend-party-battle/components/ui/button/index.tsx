...
const buttonStyle = tva({
  ...
  variants: {
    ...
    variant: {
      link: 'px-0 bg-transparent dark:bg-transparent data-[hover=true]:bg-transparent dark:data-[hover=true]:bg-transparent data-[active=true]:bg-transparent dark:data-[active=true]:bg-transparent',
      outline:
