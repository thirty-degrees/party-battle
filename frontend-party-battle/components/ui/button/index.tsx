...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      ...
      secondary:
        'bg-secondary-500 dark:bg-secondary-500 border-secondary-300 dark:border-secondary-700 data-[hover=true]:bg-secondary-600 dark:data-[hover=true]:bg-secondary-400 data-[hover=true]:border-secondary-400 dark:data-[hover=true]:border-secondary-600 data-[active=true]:bg-secondary-700 dark:data-[active=true]:bg-secondary-300 data-[active=true]:border-secondary-700 dark:data-[active=true]:border-secondary-300 data-[focus-visible=true]:web:ring-indicator-info',
      positive:
